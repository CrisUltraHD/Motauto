...
public class Cliente {
	...
	public void modificarCliente(Database db) {
		...
		try 
		{
		correcto = db.ExecuteUpdate("UPDATE clientes SET dni='"+this.dni+"',"+"nombre='"+this.nombre+"',"+"apellidos='"+this.apellidos+"',correo='"+this.correo+"',telefono='"+this.telefono+"',direccion='"+this.direccion+"';");			
