...
public class Cliente {
	...
	public void insertCliente(Database db) {
		...
		try 
		{
		correcto = db.ExecuteUpdate("INSERT INTO clientes VALUES ('"+ this.dni +"','"+ this.nombre + "','"+ this.apellidos +"','"+ this.correo + "','"+ this.telefono +"','"+ this.direccion +"');");			
	...
	public void modificarCliente(Database db) {
		...
		try 
		{
		correcto = db.ExecuteUpdate("UPDATE clientes SET dni='"+this.dni+"',"+"nombre='"+this.nombre+"',"+"apellidos='"+this.apellidos+"',correo='"+this.correo+"',telefono='"+this.telefono+"',direccion='"+this.direccion+"' WHERE dni = '"+this.dni+"';");			
