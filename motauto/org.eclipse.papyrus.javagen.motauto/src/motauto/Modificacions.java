...
public class Modificacions {
	...
	public static void CrearFactura(Database db) {
		...
		while (!fiArticles) {
			...
			else if (Comprovaciones.comprovarCodigoArticulo(codigo, db)) 
			{
				...
				float totalMenosDescuento = (total - (total*descuento));

				System.out.println("Precio total calculado de la fila" + totalMenosDescuento);
				totalFiles += totalMenosDescuento;

				// GENEREM UNA FILA I LA GUARDEM AL ARRAYLIST
				FacturaFiles ff = new FacturaFiles(cantidad, articulo, fh, descuento, totalMenosDescuento);
				filas.add(ff);
			}
		}
	...
	public static void ModificarFactura(Database db) {
		...
		case 1:
			...
			System.out.println("11 - Modificar Total Factura");
			System.out.println("12 - Modificar Observaciones");
			int opcion2 = Utiles.menu(12);
			...
			case 11:
				System.out.println("Modificar Total Factura: ");
				float totalFactura = Utiles.demanarNumFloat();
				
				fh.setTotalFactura(totalFactura);
				fh.modificarFactura(db);
				break;
		...
		//MODIFICAR FILAS
		case 2:
			System.out.println("1 - Modificar Codigo Articulo");
			System.out.println("2 - Modificar Cantidad");
			System.out.println("3 - Modificar Descuento");
			System.out.println("4 - Modificar Precio Total");
			...
			case 4:
				System.out.println("Modificar Precio Total: ");
				float precioTotal = Utiles.demanarNumFloat();
				
				ff.get(posArrayList).setPrecio_total(precioTotal);
				ff.get(posArrayList).modificarFilaFactura(db);
				break;
			}
